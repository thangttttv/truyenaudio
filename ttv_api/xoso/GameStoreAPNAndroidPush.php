...
class APNS_Android_Push
{
           ...
           while (true)
            {
                ...
                $stmt = $this->pdo->prepare('SELECT * FROM g_notice_queue Where os_type = 2  LIMIT 100');
                $stmt->execute();
   ...
   function send_push_notification($messageId,$registatoin_ids, $message) {
        ...
        $headers = array(
            'Authorization: key=' . "AIzaSyB591JNcRpDMJrtPMKE3wYJVTM11dVEqBk",
            'Content-Type: application/json'
        );
        
        echo "AIzaSyB591JNcRpDMJrtPMKE3wYJVTM11dVEqBk---1ww133355";
